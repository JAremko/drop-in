...
RUN apk add --update libseccomp --update-cache --repository http://dl-3.alpinelinux.org/alpine/edge/main && \
    apk add --update tmux git curl fish docker bash mosh-server htop python py-pip openssh python-tests     \
