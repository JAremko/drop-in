####*Remote developer environment based on the [Alpine Linux](http://www.alpinelinux.org/), [Vim](http://www.vim.org/), [tmux](https://tmux.github.io/) and [Mosh](https://mosh.mit.edu/)*
